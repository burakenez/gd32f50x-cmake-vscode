[![GitHub tag (latest by date)](https://img.shields.io/github/v/tag/burakenez/gd32f50x-cmake-vscode)](https://github.com/burakenez/gd32f50x-cmake-vscode/tags/)

# GD32F50x Demo Suites CMake Visual Studio Code Integration

🚀 Welcome to the **GD32F50x Demo Suites CMake Visual Studio Code** repository! This project integrates the CMake build system with Visual Studio Code for **_[GD32F50x Demo Suites V1.0.4](https://www.gd32mcu.com/en/download)_** and **_[GD32F50x Firmware Library V1.0.4](https://www.gd32mcu.com/en/download)_**, running entirely inside a container — **no local toolchain installation needed**.
...
```bash
git clone https://github.com/burakenez/gd32f50x-cmake-vscode.git
```
...
### 2. **CMSIS/GD/GD32F50x**
- **Version:** `V1.0.4 (2026-02-25)`
- **Path:** `Drivers/CMSIS/GD/GD32F50x`
- **Source:** `GD32F50x Demo Suites V1.0.4`

### 3. **GD32F50x_standard_peripheral**
- **Version:** `V1.0.4 (2026-02-25)`
- **Path:** `Drivers/GD32F50x_standard_peripheral`
- **Source:** `GD32F50x Demo Suites V1.0.4`

### 4. **GD32F50x_usbfs_library**
- **Version:** `V1.0.4 (2026-02-25)`
- **Path:** `Drivers/GD32F50x_usbfs_library`
- **Source:** `GD32F50x Demo Suites V1.0.4`
...
│           │   ├── Core
│           │   │   ├── Inc
│           │   │   │   ├── gd32f50x_it.h      # Interrupt handler declarations
│           │   │   │   ├── gd32f50x_libopt.h  # Library options
│           │   │   │   └── systick.h                                  # SysTick timer declarations
│           │   │   └── Src
│           │   │       ├── gd32f50x_it.c      # Interrupt service routines
│           │   │       ├── main.c                                     # Application entry point
│           │   │       ├── system_gd32f50x.c  # Clock and core initialisation
│           │   │       └── systick.c                                  # SysTick timer implementation
│           │   ├── Startup
│           │   │   └── startup_gd32f50x.s     # Reset handler and vector table
...
│           ├── Drivers
│           │   ├── BSP/GD32F503C_START              # Board support package for GD32F503C_START
│           │   ├── CMSIS                                 # CMSIS for Cortex-M / GD32F50x
│           │   └── GD32F50x_standard_peripheral  # Standard peripheral library
│           ├── .clang-format                # Code style rules
│           ├── CMakeLists.txt               # Top-level CMake build file
│           ├── CMakePresets.json            # Debug / Release preset definitions
│           ├── gd32f50x_flash.ld  # Linker script (memory regions)
│           └── GD32F50x.svd             # SVD file for peripheral register views
